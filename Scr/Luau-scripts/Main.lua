    ...
    function window:CreateTab(tabConfig)
        ...
        function tab:CreateSlider(sliderConfig)
            ...
            return {
                ...
                Destroy = function(self) sliderFrame:Destroy() end
            }
        end
        ...
        function tab:CreateDropdown(dropdownConfig)
            ...
            local function toggleDropdown()
                ...
                if open then
                    ...
                    C.tween(optionsFrame, {Size = UDim2.new(0, dropdownFrame.AbsoluteSize.X, 0, #dropdownConfig.Options * 30)}, 0.2)
                    arrow.Text = "^"
                else
                ...
                for _, option in ipairs(dropdownConfig.Options) do
                    ...
                    optionBtn.MouseButton1Click:Connect(function()
                        ...
                        if dropdownConfig.Callback then
                            local ok, err = pcall(dropdownConfig.Callback, option)
            ...
            return {
                ...
                Destroy = function(self) optionsFrame:Destroy(); dropdownFrame:Destroy() end
            }
        end
        ...
        function tab:CreateInput(inputConfig)
            ...
            textBox.FocusLost:Connect(function()
                ...
                if inputConfig.Callback then
                    local ok, err = pcall(inputConfig.Callback, textBox.Text)
